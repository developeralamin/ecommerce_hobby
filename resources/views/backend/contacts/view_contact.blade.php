...
<div class="content-wrapper">
    ...
    <div class="col-9">
<h4 class="card-header  text-center" style="background: #000000;color: white">View Contact List </h4>
     <div class="box">
...
<a href="{{ route('contact.delete',$item->id) }}" class="btn btn-danger btn-sm" id="delete">Delete</a>
