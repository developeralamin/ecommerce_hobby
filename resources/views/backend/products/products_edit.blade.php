...
<div class="container col-11  align-center">
  ...
  <form action="{{route('product.update',$editproducts->id)}}" method="post" enctype="multipart/form-data">
	  ...
	  <div class="row"> {{-- /// 1st row --}}
		...
		<div class="col-md-6" >		
		    <div class="form-group">
		      ...
		      <input type="text"  class="form-control" id="product_name" placeholder="Enter Product name" value="{{ $editproducts->product_name }}" name="product_name">
	...
	<div class="col-md-6" >		
      ...
      <select name="category_id" id="category_id"   class="form-control">
       ...
       @foreach($categories as $category) 
        <option value="{{$category->id}}" {{($editproducts->category_id == $category->id)?'selected':''}}>{{$category->category_name}}</option>
       @endforeach
	  ...
	  <div class="row"> {{-- /// 2nd row --}}
       ...
       @foreach($subcategories as $category) 
        <option value="{{$category->id}}" {{ ($editproducts->subcategory_id == $category->id)?'selected':'' }}>{{$category->sub_category_name}}</option>
       @endforeach
		 ...
		 <div class="col-md-6" >		
		    <div class="form-group">
		      ...
		      <input type="text" class="form-control" id="product_price" placeholder="Ex: 50"  value="{{ $editproducts->product_price }}" name="product_price">
	  ...
	  <div class="row"> {{-- /// 3rd row --}}
		...
		<div class="col-md-6" >		
		    <div class="form-group">
		      ...
		      <input type="text" class="form-control" id="product_quantity" placeholder="Ex: 10"  value="{{ $editproducts->product_quantity }}"  name="product_quantity">
		...
		<div class="col-md-11" >		
          ...
          <textarea type="text" class="form-control" id="product_description"  rows="10" name="product_description">
          	 {{  $editproducts->product_description}}
          </textarea>
...
<div class="controls">
 <img id="blah" alt="your image" width="400" height="400" 
  src="{{ url('uploads/thumbnail/'.$editproducts->product_thumbnail) ?? ''}}" style="width: 300px;height: 300px;border: 1px solid #000000" alt="User Avatar"> 
